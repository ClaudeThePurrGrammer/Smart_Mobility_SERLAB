...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { icon: 'star-outline',       label: 'Programma fedeltà',    onPress: () => router.push('/(app)/promotions') },
    ],
  },
  {
    title: 'Preferenze',
  ...
  },
  {
    title: 'Supporto',
    items: [
      { icon: 'headset-outline',    label: 'Servizio clienti',     onPress: () => router.push('/(app)/report') },
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <LinearGradient colors={['#1A0A2E', '#0D0D1A']} style={styles.header}>
        ...
        <Text style={styles.since}>Membro da {MOCK_USER.since}</Text>
      ...
      <View style={styles.statsRow}>
        <View style={styles.stat}>
          <Text style={styles.statValue}>{MOCK_USER.rides}</Text>
          <Text style={styles.statLabel}>Corse</Text>
        </View>
        <View style={[styles.stat, styles.statBorder]}>
          <Text style={styles.statValue}>{MOCK_USER.km}</Text>
          <Text style={styles.statLabel}>Km totali</Text>
        </View>
        <View style={styles.stat}>
          <Text style={[styles.statValue, { color: Colors.accent }]}>{MOCK_USER.points}</Text>
